...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\.name"))
@put.on(events.NewMessage(incoming=True, pattern=r"\.name"))
async def _(event):
    if event.fwd_from:
        return
    ...
    try:
        await borg(
            functions.account.UpdateProfileRequest(  # CODES BY @THERIZOEL
                first_name=first_name, last_name=last_name
            )
        )
        await event.edit("Name was changed successfully")
    except Exception as e:  # KANGERS KANG WITH CREDIT CODES BY THERIZOEL
        await event.edit(str(e))
        
@idk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
@put.on(events.NewMessage(incoming=True, pattern=r"\.pic"))
async def _(event):
    if event.fwd_from:
        return
    ...
    try:
        ...
        if photo:
            ...
            try:
                await borg(
                    functions.photos.UploadProfilePhotoRequest(  #codes by RiZoeL
                        file
                    )
                )
            except Exception as e:  # kang with creadit
                await event.edit(str(e))
            else:
                await event.edit("Profile picture was succesfully changed")
    try:
        os.remove(photo)
    except Exception as e:  # Kangers ke maaki chut
        logger.warn(str(e))  #Knagers tek dik
...
async def alive(e):
    if e.sender_id in SMEX_USERS:
        text = " ♡︎ 𝐑ɪ𝐙ᴏᴇ𝐋 𝐌ᴜʟᴛ𝐈 𝐒ᴘᴀ𝐌 𝐁ᴏ𝐓 ♡︎\n\n\n 𝐑ɪ𝐙ᴏᴇ𝐋 𝐒ᴘᴀᴍ ɪs 𝐀ʟɪᴠᴇ !!\n\n ┏━━━━━━━━━━━━━━━━━━━\n ┣➣ ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ : 3.9.6\n ┣➣ ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ : 1.17 \n ┣➣ sᴜᴘᴘᴏʀᴛ : [ᴊᴏɪɴ](https://t.me/DNHxHELL)\n ┣➣ ᴄʀᴇᴀᴛᴇʀ : [ʀɪᴢᴏᴇʟ](https://t.me/TheRiZoeL)\n ┗━━━━━━━━━━━━━━━━━━━\n\n ʀᴇᴘᴏ : [ʜᴇʀᴇ](https://github.com/MrRizoel/RiZoeLMultiSpamBot) [.](https://telegra.ph/file/fcf3b476f035ae8384607.jpg) "
        await e.reply(text, parse_mode=None, link_preview=None )
